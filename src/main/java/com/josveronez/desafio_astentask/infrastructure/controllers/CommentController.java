...
public class CommentController {
    ...
    public ResponseEntity<CommentResponseDTO> create(@PathVariable Long taskId, @RequestBody @Valid CommentRequestDTO request) {
    ...
    public ResponseEntity<CommentResponseDTO> updateById(@PathVariable Long id, @RequestBody @Valid CommentUpdateDTO request) {
